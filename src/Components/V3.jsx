...
import { GetAllMembersDoV3, getAllUsersFromserver } from "../Redax/Users/UserThank";
import { withRouter } from 'react-router-dom';

    export default withRouter(function V3(Props) {
    ...
    const dispatch = useDispatch();
       ...
       useEffect(async () => {
           ...
           myUsersFromServer = await GetAllMembersDoV3(dispatch);
