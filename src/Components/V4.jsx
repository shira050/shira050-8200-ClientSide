...
import { GetAllMembersDoV4, getAllUsersFromserver } from "../Redax/Users/UserThank";
import { withRouter } from 'react-router-dom';

    export default withRouter(function V4(Props) {
    ...
    const dispatch = useDispatch();
       ...
       useEffect(async () => {
           ...
           myUsersFromServer = await GetAllMembersDoV4(dispatch);
