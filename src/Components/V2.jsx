...
import { GetAllMembersDoV2, getAllUsersFromserver } from "../Redax/Users/UserThank";
import { withRouter } from 'react-router-dom';

    export default withRouter(function V2(Props) {
    ...
    const dispatch = useDispatch();
       ...
       useEffect(async () => {
           ...
           myUsersFromServer = await GetAllMembersDoV2(dispatch);
